...
public class CsodalatosElme {
    ...
    public CsodalatosElme(String text) {
        this.text = text;
    }
    ...
    public static void main(String[] args) {
        ...
        //IMPORTANT: multiline strings only work with java 14 or above
        String text = """
                ...
                H4 7375Z377, 05ZD M3G M450KK4L 15!
                                """;
        CsodalatosElme csodalatosElme = new CsodalatosElme(text);
        System.out.println(csodalatosElme.getReadableText());
    }
}
